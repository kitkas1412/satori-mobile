...
export function EditStudyTimeScreen() {
  ...
  const [selected, setSelected] = useState(prefs?.preferredStudyTime ?? "");

  const handleConfirm = () => {
    if (!selected) return;
    updatePrefs(
      { preferredStudyTime: selected },
