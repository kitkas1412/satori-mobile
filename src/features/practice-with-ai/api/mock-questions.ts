...
const QUESTION_POOL: Record<SessionType, PracticeQuestion[]> = {
  VOCAB_DRILL: VOCABULARY_QUESTIONS,
  GRAMMAR_DRILL: GRAMMAR_QUESTIONS,
  KANJI_READING: KANJI_QUESTIONS,
  SENTENCE_BUILD: SENTENCE_QUESTIONS,
  MIXED_LESSON: COMBINED_QUESTIONS,
};
