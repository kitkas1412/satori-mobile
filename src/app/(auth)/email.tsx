  ...
  return (
    <ScrollView className="flex-1 bg-background-default">
      <View className="px-4 pt-4">
        ...
        <View className="mt-5 rounded-[8px] border border-gray-400 px-[14px] py-[16.5px] flex-row items-center gap-[16px] bg-white">
          <IconSymbol name="envelope" size={24} className="text-text-muted" />
          <TextInput
            value={email}
      ...
      <View className="absolute left-4 right-4 bottom-[42px]">
        <TouchableOpacity
          ...
          className="rounded-[8px] bg-primary-default items-center justify-center px-[14px] py-[16.5px]"
          accessibilityRole="button"
          accessibilityLabel="Tiếp tục"
        >
          <Text className="font-heading text-[18px] text-gray-100">
            Tiếp tục
          </Text>
        </TouchableOpacity>
      </View>
