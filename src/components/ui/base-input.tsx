    ...
    return (
      <>
        ...
        <TouchableOpacity
          ...
          className={`${label ? "mt-2" : "mt-5"} rounded-[8px] border ${hasError ? "border-red-500" : "border-[rgba(0,0,0,0.38)]"} px-[14px] py-[16.5px] flex-row items-center gap-[16px] bg-white ${containerClassName}`}
        ...
        >
          ...
          <TextInput
            ...
            className={`flex-1 font-body text-[16px] text-typography-black ${inputClassName}`}
